...
const aboutSchema = {
  ...
  "@type": "ProfilePage",
  name: "About Jude Ibor",
  url: `${siteUrl}/about`,
  mainEntity: {
    "@type": "Person",
    "@id": `${siteUrl}/#jude-ibor`,
    name: "Jude Ibor",
    alternateName: "Jude Ibor",
    url: siteUrl,
      ...
      <main className="mx-auto max-w-5xl px-6 py-16 sm:px-8 lg:px-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-zinc-600 dark:text-zinc-300">
              <p>
                ...
                (B.Sc.) at the University of Cross River State (UNICROSS), where I am in my 300
                level.
              </p>
              <p>
                My journey in technology is driven by a deep curiosity about how systems work and
                how technology can be used to create scalable solutions that solve real-world
                problems.
              </p>
              <p>
                I am the Founder and CEO of Vector Network (vNetwork), a decentralized
                vector-based economic system designed to redefine how value, trust, lending,
                staking, and digital economies function.
              </p>
              <p>
                The vision behind Vector Network is to move beyond traditional static finance into
                a dynamic system where value behaves like vectors — flowing, interacting, evolving,
                and carrying programmable economic behavior across decentralized environments.
              </p>
            </div>
          </div>
        ...
        <section className="grid gap-8 border-t border-zinc-200 py-12 dark:border-zinc-800 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-base leading-8 text-zinc-600 dark:text-zinc-300">
              ...
              HTML5, CSS3, Node.js, Python, Firebase, REST APIs, blockchain technologies,
              databases, and AI-related tools.
            </p>
          </div>
        ...
        <section className="border-t border-zinc-200 py-12 dark:border-zinc-800">
          ...
          <p className="mt-4 max-w-3xl text-base leading-8 text-zinc-600 dark:text-zinc-300">
            ...
            execution. I believe vision without execution is incomplete, and I build with the goal
            of creating useful, scalable, and technically sound systems.
          </p>

          <p className="mt-4 max-w-3xl text-base leading-8 text-zinc-600 dark:text-zinc-300">
            I am expanding my skills in software engineering, decentralized systems, AI
            integration, and product architecture while actively developing projects that reflect
